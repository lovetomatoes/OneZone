...
// const double G=6.67408e-8, c=2.9979245e10, k_B=1.38e-16, m_H=1.67e-24; // to match CII.f, OI.f
const double gamma_adb=5./3, pi=3.141593;
// const double gamma_adb=5./3, pi=3.14159265358979;  // to match CII.f, OI.f
const double mu = 1.2;
